...
class _DownloadsFolderState extends State<DownloadsFolder>
                            ...
                            if ((snapshot.data?.length ?? 0) > 0) {
                              return InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Text(
                                    !isDelete
                                        ? TranslationHelper.tr("Delete")
                                        : TranslationHelper.tr("Complete"),
  ...
  void deleteAllFiles() async {
    Get.dialog(
      AlertDialog(
        ...
        actions: <Widget>[
          TextButton(
            child: Text(TranslationHelper.tr("Cancel")),
            onPressed: () {
              Get.back();
            },
          ),
  ...
  void deleteFiles() async {
    ...
    Get.dialog(
      AlertDialog(
        title: Text(
          TranslationHelper.tr("Do you want to delete?"),
          style: Get.textTheme.titleMedium,
        ),
